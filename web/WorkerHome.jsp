...
.dropdown:hover .dropbtn {
    ...
    <body background="m12.jpg" >
        ...
        <hr>
        <h2 align="center">Worker Home</h2>
...
<div class="w3-container" id="about">
  <div class="w3-content" style="max-width:700px">
    <h5 class="w3-center w3-padding-64"><span class="w3-tag w3-wide">ABOUT THE Anganwadi</span></h5>
...
function myMap()
{
  myCenter=new google.maps.LatLng(23.00 , 72.00 );
  var mapOptions= {
    center:myCenter,
